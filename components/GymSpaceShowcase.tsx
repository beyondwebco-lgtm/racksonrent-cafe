    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          ...
          className="relative bg-[#FFFDF5] rounded-3xl border-2 border-[#6B0F1A] p-4 xs:p-6 sm:p-10 px-5 xs:px-8 sm:px-14 lg:px-16 shadow-[0_24px_70px_rgba(107,15,26,0.12)] overflow-hidden"
        >
