    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 sm:mb-10 flex items-center justify-center">
          <div className="flex flex-wrap gap-1.5 sm:gap-3 justify-center max-w-5xl mx-auto px-1 sm:px-2">
            {SHOWCASE_CATEGORIES.map((cat, idx) => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-4 py-1.5 sm:py-2.5 rounded-full text-[11px] xs:text-xs sm:text-sm font-extrabold border transition-all cursor-pointer min-h-[36px] sm:min-h-[42px] ${
                    isActive
                      ? "bg-[#650000] text-[#FFFBCC] border-[#FAFA33] shadow-md scale-[1.02] sm:scale-105"
                      : "bg-[#FFFDF5] text-[#650000] border-[#F0E2E4] hover:bg-[#FFFBCC]/40"
                  }`}
                >
                  <IconComp className={`w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0 ${isActive ? "text-[#FAFA33]" : "text-[#650000]"}`} />
        ...
        <div
          ...
          className="relative bg-[#FFFDF5] rounded-3xl border-2 border-[#650000] p-4 xs:p-6 sm:p-10 px-5 xs:px-8 sm:px-14 lg:px-16 shadow-[0_24px_70px_rgba(101, 0, 0,0.12)] overflow-hidden"
        >
          ...
          <button
            ...
            className="absolute left-1.5 sm:left-4 top-1/2 -translate-y-1/2 z-30 w-9 h-9 sm:w-11 sm:h-11 rounded-full bg-[#650000] text-[#FFFBCC] border-2 border-[#FAFA33] flex items-center justify-center shadow-lg hover:bg-[#4A0000] hover:text-[#FAFA33] hover:scale-105 transition-all cursor-pointer active:scale-95"
          >
          ...
          <button
            ...
            className="absolute right-1.5 sm:right-4 top-1/2 -translate-y-1/2 z-30 w-9 h-9 sm:w-11 sm:h-11 rounded-full bg-[#650000] text-[#FFFBCC] border-2 border-[#FAFA33] flex items-center justify-center shadow-lg hover:bg-[#4A0000] hover:text-[#FAFA33] hover:scale-105 transition-all cursor-pointer active:scale-95"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            >
              <div>
                ...
                <h3 className="mt-3 text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#6B0F1A] leading-snug font-sans">
              ...
              <div>
                <span className="block text-xs font-black uppercase tracking-wider mb-2 flex items-center gap-1.5">
                  ...
                  <span className="bg-[#650000] text-[#FAFA33] px-2.5 py-0.5 rounded-md font-extrabold">Suitable For</span>
                </span>
              ...
              <div>
                <span className="block text-xs font-black uppercase tracking-wider mb-2 flex items-center gap-1.5">
                  ...
                  <span className="bg-[#650000] text-[#FAFA33] px-2.5 py-0.5 rounded-md font-extrabold">Key Benefits</span>
                </span>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {activeCategory.benefits.map((benefit, idx) => (
                    <div key={idx} className="flex items-center gap-2 text-xs sm:text-sm text-[#4A0000] font-extrabold bg-[#FAFA33]/80 p-2 rounded-xl border border-[#650000]/15 shadow-2xs">
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#FAFA33] text-[#4A0000] border border-[#650000]/30 px-6 py-3 font-extrabold text-xs sm:text-sm shadow-xs hover:bg-[#4A0000] hover:text-[#FAFA33] transition-all cursor-pointer"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#650000] text-[#FFFBCC] border border-[#650000] px-6 py-3 font-extrabold text-xs sm:text-sm shadow-xs hover:bg-[#4A0000] hover:text-[#FAFA33] transition-all cursor-pointer"
                >
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative rounded-2xl overflow-hidden border-2 border-[#650000]/20 bg-[#4A0000] shadow-[0_16px_40px_rgba(101, 0, 0,0.15)] aspect-4/5 w-full max-w-lg mx-auto group">
                <Image
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-[#4A0000] text-white px-4 sm:px-5 py-2.5 sm:py-3 rounded-2xl border-2 border-[#FAFA33] shadow-xl flex items-center justify-between text-xs sm:text-sm lg:text-base font-bold tracking-wide z-10">
        ...
        <div className="mt-12 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 pt-6 border-t border-[#F0E2E4]">
          {SHOWCASE_TRUST_ITEMS.map((item, idx) => {
            ...
            return (
              ...
              >
                <div className="p-2 rounded-xl bg-[#FFFBCC] text-[#650000] flex-shrink-0">
