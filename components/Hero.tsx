...
export default function Hero({ onSelectRole }: HeroProps) {
  ...
  const benefitItems = [
    { text: "Extra Café Space. Extra Income.", icon: <TrendingUp className="w-4 h-4 text-[#6B0F1A]" /> },
    { text: "Connect with Local Brands & Creators.", icon: <ShieldCheck className="w-4 h-4 text-[#6B0F1A]" /> },
    { text: "Verified, Trusted Café Locations.", icon: <Lock className="w-4 h-4 text-[#6B0F1A]" /> },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="text-2.5xl xs:text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold tracking-tight text-[#6B0F1A] leading-[1.18]">
              Give Your Products a Place{" "}
              <span className="bg-[#F4E409] text-[#3D0710] px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-xl inline-block mt-1 border border-[#6B0F1A]/20 max-w-full leading-tight">
                Inside a Busy Café.
              </span>
            </h1>
            ...
            <div className="relative pt-4">
              ...
              <div className="relative flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 z-10">
                ...
                <button
                  ...
                  className="animate-cta-btn-1 flex-1 relative overflow-hidden inline-flex flex-col items-center justify-center gap-0.5 rounded-2xl bg-[#F4E409] border-2 border-[#6B0F1A]/20 px-5 sm:px-6 py-3.5 text-[#3D0710] shadow-md transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1 hover:scale-[1.018] hover:shadow-[0_14px_30px_rgba(107,15,26,0.22)] active:scale-[0.97] focus:outline-none cursor-pointer group min-h-[50px]"
                >
                ...
                <button
                  ...
                  className="animate-cta-btn-2 flex-1 relative overflow-hidden inline-flex flex-col items-center justify-center gap-0.5 rounded-2xl border-2 border-[#6B0F1A] bg-[#6B0F1A] px-5 sm:px-6 py-3.5 text-[#FFF6A3] shadow-md transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1 hover:scale-[1.018] hover:shadow-[0_14px_30px_rgba(107,15,26,0.35)] active:scale-[0.97] focus:outline-none cursor-pointer group min-h-[50px]"
                >
                  ...
                  >
                    <div className="flex items-center gap-2 text-sm sm:text-base font-black">
                      <Store className="w-4 h-4 sm:w-5 sm:h-5 text-[#FFF6A3] group-hover:translate-x-1 group-hover:-translate-y-0.5 transition-transform duration-300 flex-shrink-0" />
          ...
          <div className="lg:col-span-5 relative mt-6 lg:mt-0">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              <div className="animate-hero-video-entrance rounded-3xl sm:rounded-[2rem] border-2 border-[#F0E2E4] bg-[#FFFDF5] p-2.5 sm:p-3 shadow-[0_24px_70px_rgba(107,15,26,0.10)] relative overflow-hidden transition-all duration-350 hover:scale-[1.015] hover:shadow-[0_28px_80px_rgba(107,15,26,0.18)] hover:border-[#F4E409]/60 group">
                <div className="relative aspect-4/3 w-full rounded-2xl overflow-hidden bg-[#FFF6A3]/20">
                  ...
                  {/* Overlay Badge */}
                  <div className="absolute bottom-3 right-3 sm:bottom-6 sm:right-6 bg-[#3D0710] text-white px-3 sm:px-5 py-1.5 sm:py-2.5 rounded-full border-2 border-[#F4E409] shadow-xl flex items-center gap-1.5 sm:gap-2 text-[10px] xs:text-xs sm:text-sm font-bold tracking-wide z-10 max-w-[calc(100%-1.5rem)]">
                    <span className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-[#F4E409] animate-ping flex-shrink-0" />
