...
export default function TopBar() {
  return (
    <div className="bg-[#650000] text-white text-[10px] xs:text-[11px] sm:text-xs border-b border-[#4A0000] py-2 px-3 sm:px-6 lg:px-8 font-semibold relative z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-2.5 sm:gap-4 flex-shrink-0">
          <a
            ...
            className="flex items-center gap-1 hover:text-[#FAFA33] transition-colors py-0.5 px-1 rounded active:scale-95"
          ...
          <a
            ...
            className="hidden sm:flex items-center gap-1 hover:text-[#FAFA33] transition-colors py-0.5 px-1 rounded active:scale-95"
