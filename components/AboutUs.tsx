...
export default function AboutUs() {
  ...
  const whyChooseItems = [
    "India's First Café Display Space Marketplace",
    "Innovative Café Space-Sharing Model",
    "Affordable Retail Expansion for Food Brands",
    "High Daily Footfall Café Locations",
    "Flexible Daily, Weekly & Monthly Rentals",
    "Verified Cafés & Display Units",
    "Direct Communication & Transparent Agreements",
    "No Expensive Standalone Retail Leases",
    "Dedicated Food & Brand Support",
    "Scalable Across Multiple Local Café Outlets",
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-[#650000] md:text-5xl leading-tight">
            About <span className="bg-[#FAFA33] text-[#4A0000] px-3 py-0.5 rounded-xl inline-block border border-[#650000]/20">Racks on Rent</span>
          </h2>
          
          <p className="mt-4 text-lg font-bold text-[#4A0000] sm:text-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 items-stretch">
          ...
          <div className="lg:col-span-7 bg-[#650000] text-white rounded-3xl border-2 border-[#4A0000] p-6 sm:p-8 shadow-[0_16px_40px_rgba(101, 0, 0,0.20)] flex flex-col justify-between">
            <div>
            ...
            <div className="mt-6 pt-6 border-t border-[#FFFBCC]/20">
              ...
              <div className="flex flex-wrap gap-1.5">
                {venueTypes.map((venue, idx) => (
                  <span
                    key={idx}
                    className="px-2.5 py-1 rounded-full bg-[#4A0000] text-[#FFFBCC] text-xs font-extrabold border border-[#FAFA33]/30"
                  >
                    {venue}
                  </span>
                ))}
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            {/* Our Purpose Card */}
            <div className="bg-[#650000] text-[#FFFBCC] rounded-3xl p-6 sm:p-8 shadow-[0_16px_40px_rgba(101, 0, 0,0.20)] border-2 border-[#4A0000] flex-1 flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-2 mb-3">
                  <div className="p-2 rounded-xl bg-[#FAFA33] text-[#4A0000]">
            ...
            {/* Why We Exist Card */}
            <div className="bg-[#650000] text-[#FFFBCC] rounded-3xl p-6 sm:p-8 shadow-[0_16px_40px_rgba(101, 0, 0,0.20)] border-2 border-[#4A0000]">
              <div className="flex items-center gap-2 mb-3">
                <div className="p-2 rounded-xl bg-[#FAFA33] text-[#4A0000]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          {/* Vision Card */}
          <div className="bg-[#650000] rounded-3xl border-2 border-[#4A0000] p-6 sm:p-8 shadow-[0_16px_40px_rgba(101, 0, 0,0.20)] hover:shadow-xl transition-shadow relative overflow-hidden group">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-3 rounded-2xl bg-[#FAFA33] text-[#4A0000]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {coreValues.map((val, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="bg-[#650000] rounded-2xl border-2 border-[#4A0000] p-5 shadow-[0_8px_24px_rgba(101, 0, 0,0.18)] hover:shadow-xl transition-all hover:-translate-y-1 flex flex-col justify-between"
                >
                  <div>
                    <div className="w-10 h-10 rounded-xl bg-[#FAFA33] flex items-center justify-center text-[#4A0000] mb-3">
        ...
        <div className="bg-[#650000] rounded-3xl border-2 border-[#4A0000] p-6 sm:p-10 shadow-[0_20px_50px_rgba(101, 0, 0,0.25)]">
          <div className="text-center max-w-3xl mx-auto mb-8">
            <span className="inline-flex rounded-full bg-[#FAFA33] px-3.5 py-1 text-xs font-extrabold text-[#4A0000] mb-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-3.5 max-w-4xl mx-auto">
            {whyChooseItems.map((item, idx) => (
              <div
                key={idx}
                className="flex items-center gap-3 bg-[#4A0000] p-3.5 rounded-xl border border-[#FAFA33]/30 shadow-2xs hover:border-[#FAFA33]/60 transition-colors"
              >
                <div className="p-1.5 rounded-lg bg-[#FAFA33] text-[#4A0000] flex-shrink-0">
