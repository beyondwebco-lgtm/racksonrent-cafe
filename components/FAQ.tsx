            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between gap-3 p-4 sm:p-6 text-left font-black text-sm sm:text-base lg:text-lg text-[#6B0F1A] hover:text-[#3D0710] focus:outline-none transition-colors cursor-pointer group min-h-[48px]"
                >
