    ...
    <section className="py-16 sm:py-24 bg-[#FFFDF5] border-t border-[#F0E2E4]" id="pricing">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <SectionHeader
          ...
          subtitle="No hidden commissions. Direct, transparent terms tailored for café owners and food entrepreneurs."
        />
          ...
          {PRICING_TIERS.map((tier: PricingTier) => (
            <div
              ...
              className={`rounded-3xl border-2 p-8 flex flex-col justify-between transition-all relative ${
                tier.highlighted
                  ? "border-[#650000] bg-[#FFFBCC]/20 shadow-[0_16px_40px_rgba(101, 0, 0,0.12)]"
            ...
            >
              ...
              <button
                ...
                className={`w-full py-4 px-6 rounded-full font-extrabold transition-all shadow-xs cursor-pointer text-center ${
                  tier.highlighted
                    ? "bg-[#FAFA33] text-[#4A0000] border border-[#650000]/20 hover:bg-[#4A0000] hover:text-[#FAFA33]"
                    : "bg-[#650000] text-[#FFFBCC] hover:bg-[#4A0000] hover:text-[#FAFA33]"
                }`}
              >
                {tier.ctaLabel}
              </button>
