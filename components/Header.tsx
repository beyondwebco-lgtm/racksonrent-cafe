      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 lg:hidden flex-shrink-0">
          ...
          <button
            ...
            className="p-2 sm:p-2.5 min-w-[42px] min-h-[42px] flex items-center justify-center rounded-xl text-[#650000] hover:text-[#4A0000] hover:bg-[#FFFBCC]/40 border border-[#F0E2E4] transition-colors cursor-pointer active:scale-95"
          >
        ...
        >
          ...
          <div className="py-3 px-4 sm:px-6 flex items-center justify-between border-b border-[#F0E2E4] bg-[#FFFDF5] sticky top-0 z-10">
            ...
            <button
              ...
              className="p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-xl text-[#650000] hover:bg-[#FFFBCC]/40 border border-[#F0E2E4] transition-colors cursor-pointer active:scale-95"
            >
              <X className="w-6 h-6" />
            </button>
          </div>
